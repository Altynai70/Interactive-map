...
public class CityMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		pg.fill(51,223,255);// TODO: Add code to draw a triangle to represent the CityMarker
		pg.triangle(x-5, y+10, x, y, x+5, y+10);// HINT: pg is the graphics object on which you call the graphics
